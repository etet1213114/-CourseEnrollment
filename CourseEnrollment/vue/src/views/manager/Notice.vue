<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.title" style="width: 300px; margin-right: 10px" placeholder="請輸入標題查詢"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table :data="data.tableData" stripe>
        <el-table-column label="公告標題" prop="title"></el-table-column>
        <el-table-column label="公告內容" prop="content"></el-table-column>
        <el-table-column label="發布時間" prop="time"></el-table-column>
