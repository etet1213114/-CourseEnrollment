<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.name" style="width: 300px; margin-right: 10px" placeholder="請輸入名稱查詢"></el-input>
...
const handleDelete = (id) => {
  ElMessageBox.confirm('刪除後資料無法恢復，是否確定刪除?', '刪除確認', { type: 'warning' }).then(res => {
...
const handleImgSuccess = (res) => {
  data.form.avatar = res.data  // res.data就是文件上傳返回的文件路徑，獲取到路徑後賦值表單的屬性
}
